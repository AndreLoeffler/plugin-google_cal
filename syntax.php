...
class syntax_plugin_googlecal extends DokuWiki_Syntax_Plugin {
    ...
    function render($mode, &$renderer, $data) {
        ...
        if($mode == 'xhtml'){
            ...
            switch($style) {
                case 'wiki':
                    $renderer->doc .= "<iframe style='display:none;' id='calframe' src='https://www.google.com/calendar/embed?".$disp."src=$url&amp;height=$h&amp;title=$alt' title='$alt'  width='$w' height='$h' frameborder='0'></iframe>\n".
